...
__all__ = ["LibreOfficeLanguagePackURLProvider"]
...
re_mirrorlist = re.compile(r'<a href=[\'\"](?P<mirrorlist_url>\S*langpack\S*\.dmg\.mirrorlist)[\'\"].*</a>', re.IGNORECASE)
re_metalink = re.compile(r'<a href="(?P<meta4_url>.*\.dmg\.meta4)".*</a>', re.IGNORECASE)


class LibreOfficeLanguagePackURLProvider(Processor):
